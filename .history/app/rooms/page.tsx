...
export default function RoomsPage() {
 const services = [
  ...
  "CCTV Security",
  "Free Wi-Fi & Intercom Facilities",
  "Covered Parking",
  "Travel Assistance",
  "Laundry Service (On Request)",
  "Fully Furnished Apartments",
  "Kitchen Facilities in Selected Units",
  "TV, Fridge & Washing Machine (Selected Units)",
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="space-y-6 text-white/70 text-lg leading-relaxed font-light italic mb-8">
                <p>Suites offers well-furnished 1 BHK and 2 BHK serviced apartments,
                   available in both AC and Non-AC options, providing the perfect balance of comfort, space, 
                   and affordability. Whether you are traveling with family, visiting for business, or planning a group stay, our apartments 
                  are thoughtfully designed to make you feel at home.

</p>
                <p>Ideal for family stays, business travelers, and group bookings,
                   Emerald Suites ensures a peaceful, convenient, 
                   and memorable experience with easy access to key locations across the city.
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <h3 className="text-[#c5a059] text-[10px] tracking-[0.5em] uppercase mb-6 font-bold text-center">
      Our Services & Amenities
    </h3>

    <p className="text-white/60 text-center max-w-3xl mx-auto mb-12 leading-relaxed">
      At Emerald Suites, we are committed to providing a seamless and comfortable stay with a wide range of thoughtfully curated services and amenities designed for both short and extended stays.
    </p>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-12">
      {services.map((service, index) => (
        <div
          key={index}
          className="text-white/60 font-serif italic text-lg border-l border-emerald-500/20 pl-4"
        >
          {service}
        </div>
      ))}
