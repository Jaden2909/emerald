...
export default function SignaturePage() {
 const services = [
  ...
  "Party Hall for Events & Gatherings"
];
...
<p className="text-[#c5a059] text-sm tracking-[0.4em] uppercase mb-8 font-bold">
  Kannur, Bangalore • VIP Suites & Rooms
</p>

<div className="space-y-6 text-white/70 text-lg leading-relaxed font-light italic mb-8">
  <p>
    Emerald Signature is a premium hospitality destination strategically located on Airport Road, offering unmatched convenience for both business and leisure travelers. Designed with elegance and modern comfort in mind, it represents the finest expression of the Emerald brand.
  </p>

  <p>
    We offer a variety of well-appointed accommodations including VIP Suites, Deluxe Rooms, and Standard Rooms, each crafted to deliver a refined and comfortable stay experience. Along with this, our party hall provides the perfect space for events, celebrations, and corporate gatherings.
  </p>

  <p>
    Whether you are a corporate traveler, family, or group, Emerald Signature ensures a seamless blend of luxury, convenience, and personalized service, making every stay truly special.
  </p>
</div>
